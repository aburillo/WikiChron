...
def generate_metrics():
    ...
    metrics.append(Metric('Current_streak', 'Current streak', MetricCategory.USERS, stats.current_streak, ''))
    ...
    metrics.append(Metric('users_first_edit', 'Users first edit', MetricCategory.USERS, stats.users_first_edit, 'Users whose first edition was more than 6 months ago'))
    ...
    metrics.append(Metric('users_last_edit', 'Users last edit', MetricCategory.USERS, stats.users_last_edit, ''))
    ...
    metrics.append(Metric('users_edits_number_of_edits', 'Users number of edits', MetricCategory.USERS, stats.users_number_of_edits, ''))
...
# metric 8
    ...
    metrics.append(Metric('type_page_users_edit', 'Type page users edit', MetricCategory.USERS, stats.type_page_users_edit, ''))
