...
def generate_metrics():
    ...
    metrics.append(Metric('edits users six months in a row', 'User Edit six months in a row', MetricCategory.USERS, stats.edits_user_six_months_in_a_row, 'Users that have edited six months in a row.'))
