...
def generate_metrics():
    ...
    metrics.append(Metric('users_less_than_three_months', 'LT3M', MetricCategory.USERS, stats.users_less_than_three_months, 'New users registration per month who have made at least one edition.'))
    metrics.append(Metric('users_more_than_three_months', 'MT3M', MetricCategory.USERS, stats.users_more_than_three_months, 'New users registration per month who have made at least one edition.'))
    metrics.append(Metric('talk_page_users', 'User Edit Talk Page', MetricCategory.USERS, stats.talk_page_users, 'New users registration per month who have made at least one edition.'))
